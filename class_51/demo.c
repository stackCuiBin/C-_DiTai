...
{
	struct ClassDerived* ret = NULL;
	ret = (struct ClassDerived*)malloc(sizeof(struct ClassDerived));

	if(ret != NULL)
	{
		ret->b.vptr = &g_Derived_vtbl;
		ret->b.mi = i;
		ret->b.mj = j;
		ret->mk = k;
	}
...
int Derived_getMk(Derived* pThis)
{
...
int Derived_Add(Derived* pThis, int value)
{
	...
	return obj->b.vptr->pAdd(pThis, value); 
}
